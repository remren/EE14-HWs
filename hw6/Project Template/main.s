...
__main	PROC
	...
	;*** Chapter 7, Problem 5 ***
			...
			MOV		r5, #0		; r5 = i			
rowA		CMP		r5, r3		; i < m, Iterate through all rows of A
			BGE		stop
			MOV		r6, #0		; r6 = j = 0, set rowB iterator to 0
			B		colB
postB		ADD 	r5, #1		; i++, rowA incrementer
			B		rowA

colB		CMP 	r6, r3		; j < n, n = m
			BGE		postB
			MOV		r8, #0		; r8 = SUM = 0
...
colA		CMP		r7, r4		; k < p, Iterate through all cols of A
			BGE 	postColA
			B		math
postmath	
			ADD		r8, r8, r9 	; sum += ...
